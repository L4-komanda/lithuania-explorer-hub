...
const AttractionGallery: React.FC<AttractionGalleryProps> = ({ attraction, isOpen, onClose, onEdit }) => {
  ...
  const galleryImages = attraction.image ? [attraction.image, ...mockGalleryImages] : [...mockGalleryImages];
  
  if (galleryImages.length === 0) {
    // Fallback if no images are available at all (e.g., add a placeholder image)
    galleryImages.push("https://via.placeholder.com/800x450.png?text=No+Image+Available");
  }
