...
const EditAttractionDialog: React.FC<EditAttractionDialogProps> = ({ isOpen, onClose, attraction, onSave }) => {
    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>Pakeiskite informaciją apie "{attraction.name}".</DialogDescription>
        </DialogHeader>
